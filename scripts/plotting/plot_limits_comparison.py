...
def plot_limits(dir_1l, dir_2l, dir_combined):
    ...
    for exp, color, style in zip([exp_1l, exp_2l, exp_comb], [kPink, kBlue, kBlack], [kDotted, kDotted, kSolid]):
    ...
    l.AddEntry(exp_1l, "Expected 95% CL upper limit (1l)", "L")
    l.AddEntry(exp_2l, "Expected 95% CL upper limit (2l)", "L")
    l.AddEntry(exp_comb, "Expected 95% CL upper limit (combined)", "L")
...
def main():
    ...
    parser.add_argument('dir_1l', type=Path)
    parser.add_argument('dir_2l', type=Path)
    parser.add_argument('dir_combined', type=Path)

    args = parser.parse_args()
    plot_limits(args.dir_1l, args.dir_2l, args.dir_combined)
